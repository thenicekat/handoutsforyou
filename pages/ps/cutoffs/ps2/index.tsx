...
export default function PS2Data() {
    ...
    useEffect(() => {
        setIsLoading(true)
        let filteredPS2Data = ps2Data.filter((d: PS2Item) => d.cgpa >= minCGPA && d.cgpa <= maxCGPA)
    ...
    return (
        <>
            <Head>
                ...
                <meta name="keywords" content="BITS Pilani, Handouts, BPHC, Hyderabad Campus, PS2 Cutoffs" />
            ...
            <div className="grid place-items-center">
                <div className="w-[70vw] place-items-center flex flex-col justify-between">
                    ...
                    <Link className="m-3" href={'/ps'}>
                        <button className="btn btn-outline w-full">Are you looking for chronicles?</button>
                    </Link>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-center">
                        ...
                        >
                            ...
                            {ps2Semesters.map((semester) => (
                                <option value={semester} key={semester} selected={yearRef == semester}>
                                    {semester}
                                </option>
                            ))}
                        </select>
                    ...
                    <p className="m-2">
                        NOTE: This data is crowdsourced and might not be accurate. By default data is sorted using last
                        submitted time. To sort based on other data, use the desktop mode of the website.
                    </p>
                </div>
            </div>
                                ...
                                <div className="card w-72 bg-base-100 text-base-content m-2" key={ps2Item.id}>
                                    <div className="card-body">
                                        ...
                                        <div className="flex-none">
                                            ...
                                            <p className="m-1">Name: {ps2Item.name}</p>
                                            ...
                                            <p className="m-1">Offshoot Type: {ps2Item.offshoot_type || 'NA'}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
