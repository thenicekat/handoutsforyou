...
import PSCutoffForm from '@/forms/PSCutoffForm'
import AddPageLayout from '@/layout/AddPage'
import { PS2CutoffFormData } from '@/types'
...
export default function AddPS2Response() {
    ...
    const handleSubmit = async (data: PS2CutoffFormData) => {
        setIsLoading(true)
                        ...
                        ? (() => {
                              ...
                              return response
                                  ? {
                                        ...
                                        stipend: response.stipend || 0,
                                        offshoot: response.offshoot || 0,
                                        offshootTotal:
                                            response.offshoot_total || 0,
                                        offshootType:
                                            response.offshoot_type || '',
