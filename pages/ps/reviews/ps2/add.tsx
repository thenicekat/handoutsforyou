                    ...
                    <>
                        {isLoading ? (
                            ...
                            <div className="text-center py-16">
                                <h2 className="text-2xl font-bold mb-4">No PS2 Responses Found</h2>
                                <p className="text-gray-600 mb-6">You need to submit your PS2 responses before writing a review.</p>
                                <Link href="/ps/cutoffs/ps2" className="btn btn-primary">
                                    Submit PS2 Response
                                </Link>
                            </div>
                        ) : (
                            <>
                                <div className="w-full max-w-xl mb-8">
                                    <h2 className="text-2xl mb-4">Your PS2 Responses</h2>
                                    <div className="space-y-4">
                                        {userResponses.map((response) => (
                                            ...
                                            >
                                                ...
                                                <div className="text-sm text-gray-600">
                                                    CGPA: {response.cgpa} | Stipend: ₹{response.stipend}
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="text-center w-full m-2 h-60">
                                    <textarea
                                        ...
                                        placeholder={selectedResponse ? "You are writing a review for the following PS2 response: " + selectedResponse?.station + " " + selectedResponse?.year_and_sem + " " + selectedResponse?.allotment_round : "Select a PS2 response to write a review..."}
