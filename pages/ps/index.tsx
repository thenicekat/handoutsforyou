                ...
                <div className="w-[70vw] mt-8">
                    <div className="card bg-base-200 shadow-xl">
                        <div className="card-body">
                            <h2 className="card-title text-2xl">{psResources.chronicles.title}</h2>
                            <p>{psResources.chronicles.description}</p>
                            <div className="card-actions justify-end">
                                <button className="btn btn-primary" onClick={() => {
                                    window.location.href = psResources.chronicles.link
                                }}>Explore Chronicles</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-[70vw] mt-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {psResources.ps1.map((resource) => (
                            <div className="card bg-base-100 shadow-xl" key={resource.title}>
                                <div className="card-body">
