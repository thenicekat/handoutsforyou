...
import { CursorArrowRippleIcon, DocumentDuplicateIcon, PlusCircleIcon } from '@heroicons/react/24/solid'
                                                    ...
                                                    resources[key].map((resource) => (
                                                        <div className="card w-72 h-96 bg-base-100 text-base-content m-2" key={resource.name}>
                                                            <div className="card-body">
                                                                ...
                                                                <h2 className="text-md font-bond uppercase flex">{resource.score}  Clicks <CursorArrowRippleIcon className='w-4 h-4 m-1' /></h2>
