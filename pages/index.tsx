  ...
  return (
    <>
      ...
      <div className="grid place-items-center">
        ...
        <div className="w-[70vw] place-items-center flex flex-col justify-between m-2">NOTE: Handouts might not open in jio network. You might have to change your dns settings</div>
      </div>
