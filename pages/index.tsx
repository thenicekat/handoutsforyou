    ...
    <>
      ...
      <div className='grid place-items-center'>
        <div className='w-[50vw] place-items-center flex flex-col justify-between'>
          ...
          <Link className="m-4" href={"https://github.com/Divyateja04/handoutsforyou/raw/main/public/minors.pdf"}><button className="btn btn-outline btn-primary">Info. about Minors</button></Link>
