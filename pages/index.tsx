    ...
    <>
      ...
      <div className='grid h-96 place-items-center'>
        <div className='w-[50vw] place-items-center flex flex-col justify-between'>
          ...
          <Link href={"https://github.com/Divyateja04/handoutsforyou/raw/main/public/minors.pdf"}><button className="btn btn-outline btn-primary">For Information about Minors</button></Link>
