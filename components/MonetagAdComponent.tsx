import { MONETAG_INPAGE_PUSH_CORE, MONETAG_INPAGE_PUSH_LOADER, MONETAG_VIGNETTE_BANNER_CORE, MONETAG_VIGNETTE_BANNER_LOADER, MONETAG_INTERSTITIAL_BANNER_INLINE } from '@/utils/monetagExtraInline';
...
const MonetagAdComponent: React.FC<MonetagAdComponentProps> = ({ adFormat, pageId = '' }) => {
