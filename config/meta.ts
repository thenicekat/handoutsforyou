...
export const defaultMetaConfig: MetaConfig = {
    ...
    description: "One stop destination for all your queries regarding courses, professors, placements, resources, PS, SI and more, at BITS Pilani.",
    keywords: [
        "BITS Pilani",
        "Handouts",
        "BPHC",
...
export const metaConfigs: Record<string, MetaConfig> = {
    ...
    ps: createMeta({
        ...
        description: 'Find information on Practice School at BITS Pilani Hyderabad campus - cutoffs, chronicles, reviews and more.',
    }),
    rants: createMeta({
        title: 'Rants.',
        description: 'Let all your feelings out - whether you’re lonely, happy, anxious, frustrated, or simply need to talk, just write it out here.',
    }),
    si: createMeta({
        title: 'Summer Internships.',
        description: 'Find information on Summer Internships at BITS Pilani Hyderabad campus - cutoffs, chronicles, reviews and more.',
    }),
    'higherstudies': createMeta({
        title: 'Higher Studies Resources.',
        description: 'Guidance from seniors on how to apply abroad, to kickstart your journey in higher education.',
    }),
    'ps/chronicles': createMeta({
        title: 'PS Chronicles.',
        description: 'Seniors’ experience at Practice school stations, compiled for your guidance.',
    }),
    'ps/cutoffs/ps1': createMeta({
        title: 'PS1 Cutoffs',
        description: 'CGPA cutoffs for Practice School 1, with filters to make it easy to find what you want.',
    }),
    'ps/cutoffs/ps2': createMeta({
        title: 'PS2 Cutoffs',
        description: 'CGPA cutoffs for Practice School 2, with filters to make it easy to find what you want.',
    }),
    'ps/reviews/ps1': createMeta({
        title: 'PS1 Reviews',
        description: 'Crowdsourced reviews of seniors’ experience at Practice School 1 stations.',
    }),
    'ps/reviews/ps2': createMeta({
        title: 'PS2 Reviews',
        description: 'Crowdsourced reviews of seniors’ experience at Practice School 2 stations.',
    }),
    'placements/ctcs': createMeta({
        title: 'Placement CTCs.',
        description: 'Crowdsourced CTCs at placement, searchable by department, CGPA and company for ease of retrieval.',
    }),
    ...
    'courses/handouts': createMeta({
        ...
        description: 'Handouts detailing course structure, evals, etc, searchable by course name, course code and year for ease of retrieval.',
    }),
    'courses/resources': createMeta({
        title: 'Course Resources.',
        description: 'Handwritten notes, slides, handbooks, guides, crowdsourced and filtered by subject to guide your academics.',
    }),
    'courses/pyqs': createMeta({
        title: 'Course PYQs.',
        description: 'Question papers from previous years, scraped from library website and crowdsourced, to help you with exam prep.',
    }),
    'courses/prereqs': createMeta({
        title: 'Course Prerequisites.',
        description: 'Find out what you need to have studied formally beforehand to take any particular course.',
    }),
    'courses/grading': createMeta({
        title: 'Course Grading.',
        description: 'Grade vs marks breakup with average, searchable by course name, prof name and semester for easy retrieval.',
    }),
    'courses/reviews': createMeta({
        title: 'Course Reviews.',
        description: 'Crowdsourced reviews on particular courses, searchable by course name and prof name to help you make informed choices.',
    }),
    chambers: createMeta({
        title: 'Professor Chambers.',
        description: 'Find out where to find any professor, any department. Searchable by prof name.',
    }),
    faqs: createMeta({
        title: 'FAQs.',
        description: 'Frequently asked questions - about anything from academics to campus life to placements and beyond.',
    }),
}
