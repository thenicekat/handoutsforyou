...
export default function YearComponent({ handouts, year, searchWord }: Props) {
  return (
    <div className="border-solid border-2 border-black rounded-xl p-3 m-3">
      {
          ...
          <div key={handout} className='py-1'>
            <div className="alert shadow-lg">
              ...
              <div className="flex-none">
                ...
                <Link href={"https://github.com/Divyateja04/handoutsforyou/tree/main/public/handouts/" + year + '/' + handout + '?raw=true'}><button className="btn btn-sm btn-primary">View</button></Link>
              </div>
            </div>
          </div>
        ))
